...
define process name=netclient,instances=1
{
  thread name=fileuser,memsize=10m,instances=$nthreads
  {
    ...
    flowop appendfilerand name=appendfilerand1,iosize=$wrtiosize,fd=1,directio
    flowop closefile name=closefile1,fd=1
    flowop readwholefile name=readfile1,iosize=$rdiosize,fd=2,directio
    flowop readwholefile name=readfile2,iosize=$rdiosize,fd=3,directio
